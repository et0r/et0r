...
<ul>
<li> <b>Languages:</b> Python, Java, JavaScript, Bash, PowerShell</li>
<li> <b>Frameworks & tools:</b> Tkinter, Selenium, Jest, Volatility 3, Docker, Git</li>
<li> <b>Cloud:</b> AWS (EC2, RDS, Lambda, DynamoDB, LocalStack)</li>
<li> <b>Recently built:</b> a WhatsApp document downloader (Selenium), a Windows memory-forensics case study (Volatility 3), an AWS LocalStack prototype, and a Telegram bot doing gobuster-style directory scanning</li>
<li> <b>Currently learning:</b> networking fundamentals, automata theory, OS internals, offensive security & OSINT</li>
</ul>
